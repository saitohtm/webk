...
print << "END_OF_HTML";
<font color="#FF8000">》</font><a href="/rrcd$row[2]/" title="$row[3]の賃貸マンション">$row[3]の賃貸マンション</a><br>
END_OF_HTML
}
...
$hr
<a href="/" title="賃貸プラス">賃貸プラス</a>&gt;<a href="/pref$prefid/">$pref_nameの賃貸マンション</a><br>
$hr
...
while(my @row = $sth->fetchrow_array) {
	...
	$line_cd = $row[2];
	$line_name = $row[3];
	$station_list .= qq{<font color="#FF8000">》</font><a href="/station$row[5]/" title="$row[6]の賃貸マンション">$row[6]の賃貸マンション</a><br>};
}
my $pref_name;
my $sth = $self->{dbi}->prepare(qq{select name from pref where id = ?});
$sth->execute($prefid);
while(my @row = $sth->fetchrow_array) {
	...
	$self->{html_title} = qq{$line_nameの賃貸$manshon -$line_name一人暮らし特集-};
	$self->{html_keywords} = qq{$pref_name,$line_name,$manshon,賃貸,一人暮らし,部屋探し};
	$self->{html_description} = qq{$line_nameの一人暮らし用$manshon、お部屋探しなら賃貸プラス};
	...
	&html_header($self);
print << "END_OF_HTML";
<marquee bgcolor="black" loop="INFINITY"><font color="#FFFF2B">$line_nameの一人暮らし賃貸マンションなら賃貸プラス棈一人暮らしに最高の$line_name賃貸情報は賃貸プラス</font></marquee>
<center>
<font color="#FF0000">【</font>$line_nameの賃貸マンション<font color="#FF0000">】</font>
</center>
$hr
<center>
$ad
...
$hr
<img src="http://img.waao.jp/ol03s.gif" width=46 height=52 style="float:left;margin-top:3px;margin-right:3px;margin-bottom:8px;" align="left"><font color="#FF8000">住みたい駅を選択</font><br>
<br clear="all" />
<font size=1>
$station_list
END_OF_HTML
...
print << "END_OF_HTML";
$hr
<a href="/" accesskey=0>賃貸プラス</a>&gt;<a href="/pref$prefid/">$pref_name賃貸</a>&gt;$line_name賃貸<br>
$hr
<font size=1 color="#E9E9E9">$line_nameの人暮らしの賃貸マンションなら賃貸プラス。初めての$line_nameの部屋探しは賃貸プラス</font>
$hr
END_OF_HTML
...
while(my @row = $sth->fetchrow_array) {
	...
	$self->{html_title} = qq{$station_nameの賃貸$manshon -$station_name一人暮らし特集-};
	$self->{html_keywords} = qq{$station_name, $line_name, $rr_name,$manshon,賃貸,一人暮らし,部屋探し};
	$self->{html_description} = qq{$station_nameの一人暮らし用$manshon、お部屋探しなら賃貸プラス};
...
print << "END_OF_HTML";
<marquee bgcolor="black" loop="INFINITY"><font color="#FFFF2B">$station_nameの一人暮らし賃貸マンションなら賃貸プラス棈一人暮らしに最高の$station_name賃貸情報は賃貸プラス</font></marquee>
<center>
<font color="#FF0000">【</font>$station_nameの賃貸マンション<font color="#FF0000">】</font>
</center>
$hr
<center>
$ad
...
<img src="http://img.waao.jp/ol03s.gif" width=46 height=52 style="float:left;margin-top:3px;margin-right:3px;margin-bottom:8px;" align="left"><font color="#FF8000">$station_nameの賃貸情報</font><br>
<br clear="all" />
<font size=1 color="#FF0000">$station_nameの賃貸マンション物件が検索できませんでしたm(_ _)m</font><br>
...
$hr
<a href="/" title="賃貸プラス">賃貸プラス</a>&gt;<a href="/pref$prefid/" title="$pref_nameの賃貸マンション">$pref_nameの賃貸マンション</a>&gt;<a href="/rrcd$line_cd/" title="$line_nameの賃貸マンション">$line_nameの賃貸マンション</a>&gt;$station_nameの賃貸マンション<br>
$hr
<font size=1 color="#E9E9E9">$station_nameの人暮らしの賃貸マンションなら賃貸プラス。初めての$station_nameの部屋探しは賃貸プラス</font>
$hr
END_OF_HTML
...
sub _top(){
	...
	$self->{html_title} = qq{賃貸 一人暮らしのお部屋探しは賃貸};
	$self->{html_keywords} = qq{賃貸,一人暮らし,$manshon,部屋探し,検索,敷金,礼金};
	$self->{html_description} = qq{一人暮らしのお部屋探しは、賃貸。敷金・礼金なし賃貸がおすすめ};
...
print << "END_OF_HTML";
<marquee bgcolor="black" loop="INFINITY"><font color="#FFFF2B">一人暮らしの賃貸マンションなら賃貸プラス棈あせらずじっくり賃貸マンションを探そう</font></marquee>
<center>
<img src="http://img.waao.jp/chintai.gif" width=120 height=28 alt="賃貸検索プラス"><font size=1 color="#FF0000">β版</font>
</center>
$hr
<center>
$ad
...
$hr
<img src="http://img.waao.jp/ol03s.gif" width=46 height=52 style="float:left;margin-top:3px;margin-right:3px;margin-bottom:8px;" align="left"><font color="#FF8000">住みたい賃貸エリアを選択</font><br>
<br clear="all" />
<font size=1>
END_OF_HTML
...
while(my @row = $sth->fetchrow_array) {
print << "END_OF_HTML";
<font color="#FF8000">》</font><a href="/pref$row[0]/" title="$row[1]の賃貸マンション">$row[1]の賃貸マンション</a><br>
END_OF_HTML
}
...
$hr
<a href="/" accesskey=0>賃貸プラス</a><br>
・<a href="/index.htm">賃貸プラスサイトマップ</a><br>
$hr
<font size=1 color="#E9E9E9">人暮らしの賃貸マンションなら賃貸プラス。初めての部屋探しは賃貸プラス</font>
$hr
END_OF_HTML
