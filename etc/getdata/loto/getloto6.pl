...
sub _get_loto6_real(){
	...
	my $cmd = qq{http://www.mizuhobank.co.jp/takarakuji/loto/backnumber/lt6-$page_no}.qq{.html};
	$cmd = qq{http://www.mizuhobank.co.jp/takarakuji/loto/loto6/index.html} unless($page_no);
	#print $cmd."\n";
	my $get_url = `GET $cmd`;
...
eval{
my $a = qq{insert into loto6 ( `id`,`date`,`n1`,`n2`,`n3`,`n4`,`n5`,`n6`,`nb`,`pc1`,`pc2`,`pc3`,`pc4`,`pc5`,`py1`,`py2`,`py3`,`py4`,`py5`,`am`,`coy`) values (?,?,$lotonos_str,?,$pc_str,$py_str,$cy_str)};
#print "$a\n";

my $sth = $dbh->prepare(qq{insert into loto6 ( `id`,`date`,`n1`,`n2`,`n3`,`n4`,`n5`,`n6`,`nb`,`pc1`,`pc2`,`pc3`,`pc4`,`pc5`,`py1`,`py2`,`py3`,`py4`,`py5`,`am`,`coy`) values (?,?,$lotonos_str,?,$pc_str,$py_str,$cy_str)} );
